...
CORI: Maybe say we are studying resilience in living systems using amphibian resilience to disease and other stressors as our test case.
I say this because we are on the hook with NSF to do more than study frogs :) Slides look great so far though.
:::
...
</h2> <!--# I suggest having the text for #1, 2, and 3 (i.e., Accessible, Reproducible, Inclusive) be in the same place (top-aligned) on each of these three slides. The text for the "Inclusive" slide is too close to the bottom margin. -->
:::
...
Under accessibility, instead of asking whether researchers have access to our papers maybe say "anyone who wants it" have access to our papers.
This is in the spirit of making our work accessible to policy makers, general public, etc.

I think what you have for inclusivity is fine but if you wanted to make the talking points a little more tailored you could mention that we are working to incroporate open science principals and work with these tools into our CURE courses and providing training to an ever larger audience through our RIBBiTR 101s and PEP project awardees.
But if you don't have time I think what you have is great.
Don't need to cover everything cool about RIBBiTR in 3 minutes!
:::
...
-   Allow for expansion of innovation <!--# Not sure what this means. Sharing of innovation? -->
-   Facilitate collaboration
-   Verification through efficient reproducible checking <!--# Not sure what "repoducible checking is". Reproducible analyses? Accessible code? Need to make sure that audience can connect to each bullet point - Meaning must be clearly articulated. -->
-   Transparent sharing of data <!--# Meaning? Workflow is made transparent by Open Science. Not sure how Open Science makes sharing transparent.  -->
-   Public data repositories unlock dark data <!--# "dark data" should be in quotes -->
...
Is that data <!--# Minor point - Some would argue that "data" is plural: "Are those data....." -->just sitting on a hard drive?
...
<!--# A key point is that dark data have a high likelihood of being lost over time.  -->

So utilize public data repositories, share your data, <!--# Add "make your workflow transparent," --> and lets work together to uncover the answers hidden in our data.
