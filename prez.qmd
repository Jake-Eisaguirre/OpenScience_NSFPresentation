...
::: {.fragment .r-stack fragment-index="2" .current-visible}
![](images/rstudio.png){fig-align="center" width="6in"}
:::

::: {.fragment .r-stack fragment-index="3" .current-visible}
![](images/jup.jpeg){fig-align="center" width="4in"}
:::

::: {.fragment .r-stack fragment-index="4" .current-visible}
![](images/beaver.png){fig-align="center" width="6in"}
:::

::: {.fragment .r-stack fragment-index="5" .current-visible}
